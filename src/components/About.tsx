...
function About() {
  return (
    <div className="mt-8">
      ...
      <div>
        {`I'm a software developer, student, and community builder. I currently
        study at Rwanda coding academy where I study software programming and embedded systems`}
      ...
      <div className="mt-4">
        <p>
          I code in the best tools for me in my opionions and i think i can do
          something with them
        </p>
      </div>
